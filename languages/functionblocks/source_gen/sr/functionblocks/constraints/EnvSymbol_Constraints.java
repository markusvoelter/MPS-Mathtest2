...
public class EnvSymbol_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer canBeChildBreakingPoint = new SNodePointer("r:b2d0e1d6-8b40-4064-95cd-c4befc5a41eb(sr.functionblocks.constraints)", "7691223970092884611");

  public EnvSymbol_Constraints() {
    super("sr.functionblocks.structure.EnvSymbol");
  }
  ...
  public static boolean static_canBeAChild(final IOperationContext operationContext, final CanBeAChildContext _context) {
    return SNodeOperations.isInstanceOf(_context.getParentNode(), "sr.functionblocks.structure.EnvBlock");
  }
}
